...
//If one of these variables became true it means that the player already won!
...
function slideLeft(){
    for(let r = 0; r< rows; r++){
        ...
        //Line for Animation
        let originalRow = row.slice(); //initial position before movement
    ...
    for(let r = 0; r < rows; r++){
        for(let c = 0; c < columns; c++){
            ...
            if(board[r][c] == 2048 && is2048Exists == false){
                ...
                alert("Victory! You are unstoppable at 8192!");
                is8192Exists = true;
            }
        }
    }
...
//This will listen to when we touch the screen and assigns the X coordinate of that touch
document.addEventListener('touchstart',(e) => {
    startX = e.touches[0].clientX;
    startY = e.touches[0].clientY;
})

//This will check the touch and prevent scrolling once you swipe
